...
public class TelaDeRegistro extends Application {
    ...
    public void start(Stage stage) {
        ...
        TableColumn<String[], String> colTempo = criarColuna("Total a ser pago", 6);
        TableColumn<String[], String> colValor = criarColuna("Tempo permanecido", 5);




        table.getColumns().addAll(col1, col2, col3, col4, col5, colValor, colTempo);
